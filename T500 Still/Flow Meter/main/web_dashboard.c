...
esp_err_t dashboard_handler(httpd_req_t *req)
{
    ...
    "<div class='container'>"
    "<div class='header'>"
    "<h1>🌡️ T500 Distillation Flow Meter</h1>"
    ...
    "</div>"
    "<p style='color: #7f8c8d; margin-top: 10px;'>10° (min) ← → 170° (max)</p>"
    "</div>"
    "</div>"
    ...
    "<button class='button danger' onclick='triggerOTA()'>🔄 OTA Update</button>"
